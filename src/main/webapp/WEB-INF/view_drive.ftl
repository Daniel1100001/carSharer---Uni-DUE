    ...
    <div class="drive-details">
        <div class="details-head">
            ...
            <table>
                <tr>
                    <td>Anbieter:</td>
                    <td>dummy@carSharer.de</td>
                </tr>
                <tr>
                    <td>Fahrtdatum und -uhrzeit:</td>
                    <td>01.02.2022 - 15:00 Uhr</td>
                </tr>
                <tr>
                    <td>Von:</td>
                    <td>Hamburg</td>
                ...
                <tr>
                    <td>Beschreibung:</td>
                    <td>
                        <textarea readonly>Bin Nichtraucher und fahre sehr langsam...</textarea>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="details-ratings">
            ...
            <table>
                <tr>
                    <td>n.fuhr@carSharer.de</td>
                    <td>Sehr angenehme Fahrt!</td>
                    <td>5</td>
                </tr>
            </table>
